  ...
  estrella[x].addEventListener('mouseenter', () => {
    ...
    if (estrella[x].src.includes('amarillo.png')){
      ...
      for(let i = 0; i <= x; i++) {
        ...
        estrella[i].src = '/img/amarillo.png';
     ...
     // const puntuacionElement = producto.querySelector('.puntuacion[data-producto_id="' + productoID + '"]');
      ...
      const data = {
        ...
        fetch('/puntuaciones', {
         ...
         html: '<img src="/img/amarillo.png" width="30" alt="Mi imagen">',
         ...
         showConfirmButton: false
          ...
          // estrella[4].src='/icon/estrellaYellow.png';
           ...
           // Actualizar la puntuación en el elemento correspondiente
            ...
            Swal.fire('No se puede calificar un productos mas de una vez');
