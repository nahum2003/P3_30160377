...
const transporter = nodemailer.createTransport({
  service:'Gmail',
  auth:{
    user:'theboycool24@gmail.com',
    pass:'fseqzfjjseccdajr'
  }
});
...
//-------------------------------------------
    ...
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
      ...
      res.render('clientes.ejs',{
        ...
        og: {
      title: 'Bajar peso',
      description: 'Venta de medicamentos para la perdida de peso',
      image: 'https://images.pexels.com/photos/3873209/pexels-photo-3873209.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      }
      });
...
const mensaje = {
  from:'theboycool24@gmail.com',
  to:email,
  subject:'!Bienvenido a nuestra farmacia en linea¡',
  text:`Hola ${nombre} , !gracias por registrarte esperamos nuestros servicios sean de tu agrado.¡`
  }
...
db.run(sql,[nombre_de_usuario,apellido,cedula,telefono,cliente_id,producto_id,cantidad,total_pagado,ip_cliente,codigo,numeroT,cvv,mesV,year,currency,descripcion],(err)=>{
  if(err) return console.error(err.message);
    const mailOptions = {
    from: 'theboycool24@gmail.com', // Reemplaza con tu dirección de correo electrónico
    to: destinatario, // Reemplaza con la dirección de correo del cliente
    subject:'Confirmacion', // Reemplaza con el asunto del correo electrónico
...
// Generar un token único
 ...
 res.cookie('securityToken',token, { httpOnly: true, secure: true });
  ...
  const recoveryURL = `https://webventasnahum.onrender.com/restablecer?token=${token}`;
